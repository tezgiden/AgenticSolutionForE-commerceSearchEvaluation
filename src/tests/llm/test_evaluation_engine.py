...
from llm_evaluator.search_classifier import RegexSearchClassifier
from llm_evaluator.inventory_analyzer import InventoryParser, InventoryAnalyzer
from llm_evaluator.llm_client import MockLLMClient
from llm_evaluator.response_parser import JSONResponseParser
...
class TestIntegration:
    ...
    def test_backward_compatibility_functions(self):
        ...
        from llm_evaluator import evaluate_search_results, evaluate_search_results_with_inventory
